...
Dieses Dokument legt den Geltungsbereich (Scope) des Ausgangs-IACS (Industrial Automation and Control System)  der LDPE-Anlage
der ChemoDemo AG fest.

Methodisch lehnen wir uns an ISO/IEC 27001:2024, Abschnitt 4 („Kontext der
Organisation") an, konkret an §4.1 (externer und interner Kontext) und §4.2
(Verstehen der Erfordernisse und Erwartungen interessierter Parteien). Der externe Kontext folgt
...
// =============================================================================
= 2. Kurzbeschreibung des IACS

== 2.1. Unternehmen und Anlage
...
Sensoren kontinuierlich Druck, Temperatur, Durchfluss und Füllstand; Aktoren wie Regelventile, Motoren, Pumpen und Not-Aus-Ventile setzen die Befehle der
Controller (PLCs/TIs) um. Die Kommunikation zu den Controllern läuft auf dem
Anlagenbus (TB2) über PROFINET und der Terminal Bus (TB1) verbindet Bedien- und
Engineering-Komponenten.

== 2.4. Welche Prozesse werden unterstützt?
...
- *Fern- und Service-Zugriff:* Remote Access von Mitarbeitenden und externen
  ...
  ISDN-Router (R1/R2).
- *Safety:* eigenständige Sicherheitssteuerung (Safety Instrumented System (SIS)), die sicherheitskritische Grenzwerte überwacht und bei Bedarf den
  sicheren Anlagenzustand erzwingt (Notabschaltung/ESD).
- *Sicherheit und Administration:* Security Incident Response, Patch Management, Change Management, Identity and Access Management, Asset Management, Third Party Management, Risikomanagement, Integriertes Managementsystem (Business Continuity Management, Qualitätsmanagement, Security Management, Safety Management).

#pagebreak()

// =============================================================================
= 3. Externer und interner Kontext
...
== 3.1. Externer Kontext (PESTLE-Analyse)
...
#table(
  ...
  [P - Political], [Regulatorischer Druck],[Definiert die gesetzliche Untergrenze für das Sicherheitsniveau; zwingt zur Einbeziehung der Lieferkette in den IACS-Scope.],
  ...
  [P - Political], [Industrie- und Digitalisierungspolitik (Plattform Industrie 4.0)], [Politischer Rahmen, in den die Digitalisierungsstrategie der ChemoDemo AG und die Offensive „OT Security and Resilience" eingebettet sind.],
  ...
  [S - Social], [Reputationsrisiko (Public Safety)],[Anwohner und Öffentlichkeit erwarten verlässlichen Schutz vor Stör- und Freisetzungsereignissen. Jeder Vorfall an der LDPE-Anlage wirkt auf die Reputation der gesamten ChemoDemo AG.],
  ...
  [T - Technological], [Industrie 4.0 & IIoT Konvergenz],[Auflösung des „Air-Gap“; erfordert neue Konzepte für Identitätsmanagement (IAM) und Netzwerkzonierung (Zones & Conduits nach IEC 62443.],
  [T - Technological], [Evolution der Bedrohungslage],[Zunehmende Angriffe auf OT-Umgebungen (Ransomware, gezielte DoS-Angriffe), Lieferkettenangriffe vom Typ SolarWinds, dazu Insiderbedrohungen über privilegierte Zugriffe.],
  [T - Technological], [Reife industrieller Standards],[IEC 62443, ISO/IEC 27001:2024, VDI/VDE 2182, RAMI 4.0 und IEC 61511 sind verfügbar und konsolidiert; neue Räder müssen wir hier nicht erfinden.],
  [T - Technological], [Konvergenz IT/OT],[Die saubere Trennung von IT und OT ist erforderlich.],
  [L - Legal], [Funktionale Sicherheit],[Die LDPE-Anlage fällt unter die Anforderungen für Betriebsbereiche der oberen Klasse: Sicherheitsbericht, Notfallpläne, Behördenmeldungen.],
  [L - Legal], [Datenschutzkonformität (DSGVO)],[Personenbezogene Daten in Audits, Logs, Mitarbeiterzugriffen; Begleitung durch den externen Datenschutzbeauftragten.],
  [L - Legal], [Lokale Datenschutz- und Industrieregularien],[An internationalen Standorten kommen lokale DSGVO-Pendants, lokale KRITIS- bzw. Sicherheitsregularien und Datenresidenzanforderungen dazu.],
  [L - Legal], [Haftungsrisiken der Geschäftsführung],[Dokumentationspflichten für den OT-CISO; der Scope muss lückenlose Audit-Logs für administrative Zugriffe sicherstellen.],
  ...
  [E - Environmental], [Umweltschutz & Emissionskontrolle],[IACS-Manipulation darf keine Stofffreisetzung provozieren; Integrität der Sensorwerte (Druck/Temp) ist für die Umwelt kritisch.],
...
#table(
  ...
  [Unternehmensstrategie],[Digitalisierungsstrategie + Offensive „OT Security and Resilience": alle LDPE-Anlagen sind in das bestehende ISMS zu integrieren. Der Digitale Rundgang ist die erste konkrete Digitalisierungsmaßnahme],
...
// =============================================================================
= 4. Erfordernisse und Erwartungen interessierter Parteien (Stakeholder) 
...
[Anlagenbetrieb (Plant Manager, Operator, Schichtpersonal)],
    ...
    [Externe Dienstleister (Remote-Service, Audit)],
      ...
      [Remote-Access via IPsec, Vertraulichkeitsvereinbarungen, gestufte Authentisierung.],
    [Konzern-IT (IT-Manager, IT-Abteilung)],
      [Einheitliche Standards und Tooling für IT- und OT-Domänen; Auditierbarkeit.],
      [Einheitliche Plattform; zentrale Domänencontroller; gemeinsame Patch- und AV-Infrastruktur.],
    [Kunden],
...
// =============================================================================
= 5. Abgrenzung des Geltungsbereichs (ISO/IEC 27001:2024, §4.3)

== 5.1. Was ist im Scope (innerhalb des IACS)
...
== 5.2. Was ist außerhalb des Scopes
...
== 5.3. Systemgrenzen (wo beginnt und endet das IACS)
...
- *Nach unten (Feldebene):* Das IACS beginnt an den primären Sensoren und
  ...
  Controller TI. Die physisch mechanischen Komponenten wie Reaktor, Rohrleitung,
...
- *Zum Dienstleister hin:* Die Remote Access Endpunkte wie Client C1 beim
  externen Dienstleister und RAS-Server S0 in der DMZ bilden die Grenze. Was
  beim Dienstleister liegt, ist außerhalb; die Zugangs- und Authentisierungspfade
  einschließlich Jump Server S4 sind innerhalb.
- *Zur Safety Seite:* Das Safety Instrumented System (SIS) ist als Schutzgegenstand
...
== 5.4. Geografische und organisatorische Abgrenzung
...
- *Architektur-Identität:* Die LDPE-Architektur (DMZ, Office, Operations
  ...
  umgesetzt. Komponentennamen wie FW1 bis FW4, S0 bis S6, OS1, ES1, DC1, DC2, TI
...
- *Lokale Verantwortlichkeit:* Plant Manager und PLT-Betriebsbetreuung sind
  ...
  PLT-Fachbetreuung.
- *Rechtliche Anforderungen:* Am internationalen Standort gelten
...
- *Gemeinsame Patch- und Antiviren-Infrastruktur:* WSUS- und Virus Scan Server stehen
